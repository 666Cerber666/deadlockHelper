...
```
cd existing_repo
git remote add origin https://gitlab.com/deadlock-helper/frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/deadlock-helper/frontend/-/settings/integrations)
